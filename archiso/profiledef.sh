...
file_permissions=(
  ...
  ["/usr/local/lib/codalinux/coda-install-lib.sh"]="0:0:755"
  ["/usr/share/codalinux/install/coda-install-lib.sh"]="0:0:755"
  ["/usr/share/codalinux/install/coda-install-post.sh"]="0:0:755"
  ["/usr/local/lib/codalinux/coda-install-layout.py"]="0:0:755"
  ["/usr/local/lib/codalinux/coda-install-ab.sh"]="0:0:755"
  ["/usr/local/lib/codalinux/coda-install-verify.sh"]="0:0:755"
  ["/usr/local/lib/codalinux/coda-install-split.py"]="0:0:755"
