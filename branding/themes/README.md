...
v1 branding is light. Tokens below are for later assets — do not invent a second package repo to ship them.

| Slot | Intended consumer | Status |
| --- | --- | --- |
| GTK 4 / GTK 3 theme name | nwg-look / Thunar / portals (AGS later) | placeholder (`Coda`) |
